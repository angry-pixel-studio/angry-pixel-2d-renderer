...
import { IVideoRenderData } from "../../renderData/VideoRenderData";
...
export class VideoRenderer implements IRenderer {
    ...
    public render(renderData: IVideoRenderData, cameraData: ICameraData, lastRender?: RenderDataType): void {
